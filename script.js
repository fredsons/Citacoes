// Array de citações com suas respectivas frases e autores
const quotes = [
  {
...
function getQuote() {
  ...
  // Atualiza o conteúdo dos elementos HTML com a citação e autor correspondentes
  quoteText.textContent = quotes[index].quote;
  quoteAuthor.textContent = quotes[index].author;
}

// Adiciona um listener de evento de clique ao botão para chamar a função getQuote
